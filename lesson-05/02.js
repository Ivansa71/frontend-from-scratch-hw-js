...
function updateGallery(galleryObject, galleryObjectKey, newValue) {
  if (galleryObject.hasOwnProperty(galleryObjectKey)) {
    galleryObject[galleryObjectKey] = newValue;
  } else {
    galleryObject[galleryObjectKey] = newValue;
  }
  return galleryObject[galleryObjectKey];
}
